% forces_pro_mpc_ca_solver - a fast solver generated by FORCESPRO v4.2.0
%
%   OUTPUT = forces_pro_mpc_ca_solver(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = forces_pro_mpc_ca_solver(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = forces_pro_mpc_ca_solver(PARAMS) returns 
