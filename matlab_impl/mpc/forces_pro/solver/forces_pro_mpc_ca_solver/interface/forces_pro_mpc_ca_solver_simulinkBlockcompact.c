...
#define S_FUNCTION_NAME forces_pro_mpc_ca_solver_simulinkBlockcompact
...
typedef forces_pro_mpc_ca_solverinterface_float forces_pro_mpc_ca_solvernmpc_float;

extern void forces_pro_mpc_ca_solver_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 140, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 380, 1);
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 140, 1);
