...
class Problem:
    ...
    ws_y = [-6.0, 6.0]      # m
    # robot control bound
    robot_maxVel = 1.2      # m/s
    robot_maxOmega = 2.0    # rad/s
    robot_maxAcc = 3.0      # m / s ^ 2
    robot_maxOmegaAcc = 6.0  # rad / s ^ 2
...
class Index:
    ...
    p_mpc_weights = np.s_[10: 15]       # 10, 11, 12, 13, 14
    ...
    p_mpc_weights_w_slack = np.s_[4]    # 4 in mpc_weights
