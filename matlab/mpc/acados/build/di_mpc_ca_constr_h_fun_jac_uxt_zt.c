...
CASADI_SYMBOL_EXPORT void di_mpc_ca_constr_h_fun_jac_uxt_zt_decref(void) {
}
...
CASADI_SYMBOL_EXPORT const char* di_mpc_ca_constr_h_fun_jac_uxt_zt_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    case 2: return "o2";
...
CASADI_SYMBOL_EXPORT const casadi_int* di_mpc_ca_constr_h_fun_jac_uxt_zt_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* di_mpc_ca_constr_h_fun_jac_uxt_zt_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int di_mpc_ca_constr_h_fun_jac_uxt_zt_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 3;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
