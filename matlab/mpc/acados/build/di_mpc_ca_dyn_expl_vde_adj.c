...
CASADI_SYMBOL_EXPORT void di_mpc_ca_dyn_expl_vde_adj_decref(void) {
}
...
CASADI_SYMBOL_EXPORT const char* di_mpc_ca_dyn_expl_vde_adj_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* di_mpc_ca_dyn_expl_vde_adj_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* di_mpc_ca_dyn_expl_vde_adj_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int di_mpc_ca_dyn_expl_vde_adj_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
